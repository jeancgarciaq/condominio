...
//Ingresar el gasto
$consulta = "INSERT INTO cuotasespeciales (ID, Descripcion, Comprobante, Montobs, Montousd, idcondominio, Fecha) VALUES (NULL, '$descripcion', '$comprobante', '$monto', '$montod', '$idcondominio', '$fecha')";
...
<head>
	...
	<title>Agregar Cuota Especial</title>
