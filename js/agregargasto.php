...
//Se añade a cuentas por pagar
/*if($cxp == 'Si') {
	//Ingresar el gasto
	$añadircxp = "INSERT INTO cxp (ID, Descripcion, Comprobante, Montobs, Montousd, idcondominio, Fecha, Estado) VALUES (NULL, '$descripcion', '$comprobante', '$monto', '$montod', '$idcondominio', '$fecha', 'ADEUDADO')";	
}*/

//Ingresar el gasto
$consulta = "INSERT INTO gastos (ID, Descripcion, Comprobante, Montobs, Montousd, idcondominio, Fecha) VALUES (NULL, '$descripcion', '$comprobante', '$monto', '$montod', '$idcondominio', '$fecha')";
...
<?php }
			...
			<div class="alert alert-danger" role="alert">
  				<p style="text-align: center">Se ha producido un error, por favor inténtelo de nuevo. <br> Si el error persiste comuníquese con el administrador <a href="mailto:jcvictory@hotmail.com"><i class="las la-envelope"></i> Enviar Correo</a> y/o <a href="https://wa.me/584144812738"><i class="lab la-whatsapp"></i> Escribir al WhatsApp</a></p>
			</div>
<?php }
/* cerrar la conexión */
$conexion->close();
