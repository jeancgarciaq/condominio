...
<div class="container-fluid">
	...
	<ul class="nav nav-tabs" id="myTab" role="tablist">
		<li class="nav-item">
			<a class="nav-link active" id="añadir-tab" data-toggle="tab" href="#añadir" role="tab" aria-controls="añadir" aria-selected="true"><i class="la la-pen"></i> <span class="pestana">Añadir</span></a>
		</li>
		<li class="nav-item">
			<a class="nav-link" id="editar-tab" data-toggle="tab" href="#editar" role="tab" aria-controls="editar" aria-selected="false"><i class="la la-pen"></i> <span class="pestana">Editar</span></a>
		</li>
		<li class="nav-item">
  			...
  			<article class="col-8 mt-4 mb-4">
  				<form accept-charset="utf-8" action="js/agregarpropietario.php" method="POST" class="container-fluid">
						...
						<div class="form-row mt-4">
							<div class="col form-group">
								<label><i class="las la-home"></i> Alicuota:<br> <input class="form-control" type="number" name="alicuota" data-placement="bottom" title="Si la alicuota 1.56% se debe escribir 0.0156" placeholder="0.0156" required></label>
							</div>
							<div class="col form-group">
								<label><i class="las la-phone"></i> Teléfono:<br> <input class="form-control" type="tel" name="telefono" pattern="[+][0-9]{3}[-][0-9]{3}[-][0-9]{7}" data-toggle="tooltip" data-placement="bottom" title="Coloque el signo '+' seguido del código de país, un guión con el código de la región, un guión y el número de teléfono" placeholder="+01-0123-0123456" required></label>
							</div>
							<div class="col form-group">
					      ...
					      <select name="estado" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Seleccione un Estado" placeholder="Carabobo" required>
